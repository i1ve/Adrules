...
echo '下载规则'
rules=(
  "https://raw.githubusercontent.com/Sereinfy/CN-ADList/main/rule/adblockdns.txt" #dns
  "https://raw.githubusercontent.com/Sereinfy/CN-ADList/main/rule/adblockfilters.txt" #filters
  "https://raw.githubusercontent.com/Sereinfy/CN-ADList/main/rule/filters.txt" #补充
 )
