...
def CreatReadme(ruleList, fileName):
    ...
    with open(fileName, 'a') as f:
        ...
        f.write(| ~~防跟踪保护过滤器~~             | ~~AdGuard Tracking Protection filter~~               | 阻止跟踪保护隐私                 | EasyPrivacy                       |\n")
        f.write(| 中文过滤器                       | AdGuard Chinese filter                               | EasyList反广告的中文版补充       | EasyList China                    |\n")
        f.write(| ~~社交媒体过滤器~~               | ~~AdGuard Social Media filter~~                      | ~~社交媒体内容按钮和其他小部件~~ | ~~Fanboy's Social Blocking List~~ |\n")\n")
        f.write(| 恼人广告过滤器                   | AdGuard Annoyances filter                            | Fanboy Lists                     | Fanboy's Annoyances List          |\n")
        f.write(| ~~移动广告过滤器~~               | ~~AdGuard Mobile Ads filter~~                        | 手机去广告规则                   | adgk                              |\n")
        f.write(| cookies 相关的警告               | I don't care about cookies                           | 阻止Cookie横幅、GDPR覆盖窗口     | EasyList Cookie List              |\n")
        f.write(| ~~解除搜索广告和自我推销过滤器~~ | ~~Filter unblocking search ads and self-promotions~~ | 去自我推广                       | CJX's Annoyance List              |\n")
        f.write(| ~~URL 跟踪过滤器~~               | ~~AdGuard URL Tracking filter~~                      |                                  |                                   |\n")
        f.write(| DNS 过滤器                       | DNS filter                                           |                                  |                                   |\n")
        f.write(| 反Adblock，警告删除              | Adblock Warning Removal List                         |                                  |                                   |\n")
